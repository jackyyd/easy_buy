# Generated by Django 2.2.5 on 2020-09-08 01:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='', verbose_name='图片')),
            ],
            options={
                'db_table': 'tb_brand',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_lauched', models.BooleanField(default=True, verbose_name='是否上架销售')),
                ('default_image', models.ImageField(blank=True, max_length=200, null=True, upload_to='', verbose_name='默认图片')),
                ('catepory', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.GoodsCategory', verbose_name='从属类别')),
            ],
            options={
                'db_table': 'tb_sku',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brands', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.Brand', verbose_name='品牌')),
                ('category1', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat_spu1', to='goods.GoodsCategory', verbose_name='一级类别')),
                ('category2', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat_spu2', to='goods.GoodsCategory', verbose_name='二级类别')),
                ('category3', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat_spu3', to='goods.GoodsCategory', verbose_name='三级类别')),
            ],
            options={
                'db_table': 'tb_spu',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name=True)),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name=True)),
                ('value', models.CharField(max_length=20, verbose_name='规格名称')),
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specs', to='goods.SPU', verbose_name='商品SPU')),
            ],
            options={
